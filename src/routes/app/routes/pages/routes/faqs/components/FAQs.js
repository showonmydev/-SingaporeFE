...
export const Hero = () => (
  <section className="hero">
    <div className="hero-content">
      <h1 className="hero-title">Welcome to the CleanPower.Pro Marketplace</h1>
    </div>
    <p className="hero-tagline">Buy and Sell sales leads, or hire CleanPower.Pros for your target markets.</p>
  </section>
);
