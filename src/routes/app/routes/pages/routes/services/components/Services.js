...
const Hero = () => (
  <section className="hero">
    <div className="hero-content">
      <h1 className="hero-title">Want to expand the functionality of CleanPower.Pro?</h1>
    </div>
    <p className="hero-tagline">Explore these extensions to learn how to add more features.</p>
  </section>
);
