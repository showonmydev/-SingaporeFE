  ...
  <section className="hero hero-bg-img" style={{backgroundImage: 'url(assets/images-demo/covers/photo-1438893761775-f1db119d27b2.jpg)'}}>
    <div className="hero-inner">
      <div className="hero-content">
        <h1 className="hero-title">CleanPower.Pro</h1>
      </div>
      <p className="hero-tagline">See why we are the world's largest solar sales community.</p>
    </div>
  </section>
);
      ...
      <div className="row stat-container">
        <div className="col-md-4">
          <section className="stat-item">
            <span className="stat-num">{info.experience}</span>
        ...
        <div className="col-md-4">
          <section className="stat-item">
            <span className="stat-num">{info.client}+</span>
        ...
        <div className="col-md-4">
          <section className="stat-item">
            <span className="stat-num">{info.product}</span>
...
const About = ({info}) => (
  <section className="page-about chapter">
    <QueueAnim type="bottom" className="ui-animate">
      <div key="1"><Hero /></div>
      <div key="2"><Info info={info || dummyInfo} /></div>
