...
const dummyCardInfo = {
  title: 'Card White',
  description: 'Hey there, I am a very simple card. I am good at containing small bits of information. I am quite convenient because I require little markup to use effectively.',
  learnLink: 'javascript:;',
  goLink: 'javascript:;'
};

export const CardWhite = ({ cardInfo }) => (
  <div className="col-xl-4 col-lg-6">
    <div className="card bg-color-white">
      ...
      <div className="card-action">
        <a href={cardInfo.learnLink}>Learn More</a>
        <a href={cardInfo.goLink} className="color-primary">Go To The Market</a>
      </div>
    </div>
  </div>
);
...
const MaterialCards = () => (
  <article className="article">
    ...
    <div className="row">
      ...
      <CardWhite cardInfo={dummyCardInfo} />
    </div>
  </article>
);
