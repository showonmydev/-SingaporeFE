...
import ImageCardWithProfile from './ImageCard';
    ...
    return (
      <div className="container-fluid no-breadcrumbs page-mentors">
        ...
        <QueueAnim type="bottom" className="ui-animate">
          ...
          <h2 className="article-title" style={sectionTitleStyle}>My Mentors</h2>
          <div className="row">
            {
          ...
          <h2 className="article-title" style={sectionTitleStyle}>Browse Mentors</h2>
          <div className="row">
            {
