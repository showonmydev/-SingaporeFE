    ...
    return (
      <ul className="nav" ref={(c) => { this.nav = c; }}>
        ...
        <li>
          ...
          <ul>
          	<li><FlatButton className="prepend-icon" href="#/app/training/VideoPlayback"><i className="nav-icon material-icons">business_center</i><span>VideoPlayback</span></FlatButton></li>
